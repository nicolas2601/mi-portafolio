...
</p> </div> </footer> ${renderScript($$result, "C:/Users/Usuario/Documents/proyectos Backend/mi-portafolio/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")} </body> </html>`;
